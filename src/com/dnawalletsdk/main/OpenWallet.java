...
public class OpenWallet extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		chooseAsset = (Button) findViewById(R.id.chooseAsset);
		transferSend = (Button) findViewById(R.id.transferSend);
		transferAddressEditText = (EditText) findViewById(R.id.transferAddress);
		transferAssetAmountEditText = (EditText) findViewById(R.id.transferAssetAmount);
